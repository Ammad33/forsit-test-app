<template>
  ...
  <div class="w-1/2 md:w-1/3 lg:w-64 fixed md:top-0 md:left-0 h-screen lg:block bg-gray-100 border-r z-30"
    ...
    <div class="w-full h-20 border-b flex px-4 items-center mb-8">
      <div>
        <img :src="require('@/assets/walmart-logo-459.png')" alt="Vue" />
      </div>
    </div>
    ...
    <div class="mb-4 px-4 py-4">
      ...
      <router-link to="revenue-analysis"
        class="w-full mt-2 flex items-center text-blue-400 h-10 pl-4 hover:bg-gray-200 rounded-lg cursor-pointer">
        ...
        <span class="text-gray-700">Revenue Analysis</span>
      </router-link>
      ...
      <router-link to="product-registration"
        class="w-full mt-2 flex items-center text-blue-400 h-10 pl-4 hover:bg-gray-200 rounded-lg cursor-pointer">
        <svg class="h-6 w-6 fill-current mr-2" viewBox="0 0 20 20">
          <path
        ...
        <span class="text-gray-700">Product Registration</span>
      </router-link>
